...
# Parsing + Configuration Script – Flow_meter - Rev. A

This **Parsing + Configuration** script is designed for the **Flow_meter** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Flow_meter Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Flow_meter** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
