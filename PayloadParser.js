...
*/
    var mensaje=payload.asJsonObject();
    //JsonField(Json, ‘$.loginCount’)
    var volumeSensor = device.endpoints.byType(endpointType.volumeSensor);
	if (volumeSensor != null)
	{
	    //var volume = JsonField(mensaje,'$.caudal');
		volumeSensor.updateVolumeSensorStatus(mensaje.caudal);
	}
}
